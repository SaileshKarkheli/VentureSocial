        ...
        >
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="text-center text-[10px] text-zinc-500">
              {view === 'login' ? (
                <>Don't have an account? <button type="button" onClick={() => setView('signup')} className="font-bold text-orange-500 hover:underline">Sign Up</button></>
              ) : (
                <>Back to <button type="button" onClick={() => setView('login')} className="font-bold text-orange-500 hover:underline">Log In</button></>
              )}
            </div>
