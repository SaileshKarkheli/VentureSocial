...
export default function Login() {
  ...
  return (
    <motion.div 
      ...
      className="min-h-screen bg-tint flex flex-col md:flex-row relative"
    >
      ...
      <div className="hidden md:block md:w-1/2 relative bg-zinc-200 overflow-hidden">
        ...
        >
          <h1 className="text-4xl lg:text-5xl font-display font-bold mb-3 drop-shadow-lg">
            Venture<span className="text-flame">Social</span>
          </h1>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-12 relative">
        ...
        <div className="w-full max-w-md relative z-10">
          <div className="md:hidden text-center mb-8">
            ...
            <p className="text-sm text-body mt-1">Your travel memories, shared with the world.</p>
          </div>
