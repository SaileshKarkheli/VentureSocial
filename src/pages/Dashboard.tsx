  ...
  return (
    <div className="min-h-screen bg-zinc-50 flex flex-col items-center justify-center p-6">
      <motion.div 
        ...
        className="bg-white p-12 rounded-[2rem] border border-zinc-100 shadow-xl max-w-lg w-full text-center"
      >
        <div className="w-20 h-20 bg-orange-500/10 text-orange-500 rounded-full flex items-center justify-center mx-auto mb-6">
          <Compass size={40} />
        </div>
        <h1 className="text-3xl font-display font-bold text-[#0A192F] mb-4">
          Welcome to the Dashboard
        </h1>
        <p className="text-zinc-500 mb-8">
          You are successfully authenticated as <strong className="text-zinc-900">{userProfile?.full_name || 'Traveler'}</strong>.
