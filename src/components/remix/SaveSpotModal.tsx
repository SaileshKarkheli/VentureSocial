      ...
      <AnimatePresence>
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm bg-white rounded-3xl shadow-2xl p-8 border border-zinc-100 text-center space-y-6"
          >
            <button 
              onClick={onClose} 
              className="absolute top-4 right-4 p-2 rounded-full hover:bg-zinc-100 transition-colors text-zinc-500"
            >
              <X size={20} />
            </button>
            ...
            <div>
              <h3 className="text-2xl font-display font-bold text-[#0A192F] mb-2">Join VentureSocial</h3>
