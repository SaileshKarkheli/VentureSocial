...
export default class ErrorBoundary extends React.Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-tint text-center">
          ...
          <div className="flex gap-4">
            <button 
              ...
              className="px-6 py-3 bg-ink hover:bg-black text-white font-bold rounded-xl transition-all shadow-lg"
            >
              Reload Page
            </button>
            <button 
